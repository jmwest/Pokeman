...
double OPTTSP::make_fly_TSP(vector <node> &nodes, vector <int> &route, const int &num_pokemon) {
...
double OPTTSP::calculate_partial_MST(const vector <node> &nodes, vector <bool> in_tree, const int &start, const int &num_in) {
